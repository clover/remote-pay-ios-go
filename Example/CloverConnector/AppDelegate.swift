...
//        let config : CloverGoDeviceConfiguration = CloverGoDeviceConfiguration.Builder(apiKey: "", secret: "", env: .test).accessToken("").deviceType(.RP450).allowDuplicateTransaction(true).allowAutoConnect(true).build()
//
